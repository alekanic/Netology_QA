...
public class TripCardPage {
    ...
    public ru.netology.dailyTrip.pages.TripFormPage clickPayButton() {
        payButton.click();
        formHeading.should(Condition.visible, Condition.text("Оплата по карте"));
        return new ru.netology.dailyTrip.pages.TripFormPage();
    }

    public ru.netology.dailyTrip.pages.TripFormPage clickCreditButton() {
        creditButton.click();
